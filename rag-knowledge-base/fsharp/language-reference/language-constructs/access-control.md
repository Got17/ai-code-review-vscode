# Access Control
_Access control_ refers to declaring which clients can use certain program elements, such as types, methods, and functions.
...
*   `internal` indicates that the entity can be accessed only from the same [assembly](../../standard/assembly/).
...
```
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/Access-Control

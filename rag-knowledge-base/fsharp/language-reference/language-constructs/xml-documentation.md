...
For more information, see [GenerateDocumentationFile property](../../core/project-sdk/msbuild-props#generatedocumentationfile).
```
...
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/xml-documentation

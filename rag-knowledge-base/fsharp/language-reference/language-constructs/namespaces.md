...
For more information, see [Modules](modules).
...
This feature is also available for top-level [Modules](modules).

> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/namespaces

...
Note that the result type is a [struct discriminated union](discriminated-unions#struct-discriminated-unions). Structural equality semantics apply here.

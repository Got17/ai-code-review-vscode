...
| `uint8`, `byte` | [Byte](/en-us/dotnet/api/system.byte) | Values from 0 to 255. | `1uy` |
| `int8`, `sbyte` | [SByte](/en-us/dotnet/api/system.sbyte) | Values from -128 to 127. | `1y` |
...
| `int32`, `int` | [Int32](/en-us/dotnet/api/system.int32) | Values from -2,147,483,648 to 2,147,483,647. | `1` |
| `uint32`, `uint` | [UInt32](/en-us/dotnet/api/system.uint32) | Values from 0 to 4,294,967,295. | `1u` |
...
| `decimal` | [Decimal](/en-us/dotnet/api/system.decimal) | A floating point data type that has at least 28 significant digits. | `1.0m` |
...
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/basic-types
...
By using the name `Item`, the compiler treats the property as a default indexed property. A _default indexed property_ is a property that you can access by using array-like syntax on the object instance. For example, if `o` is an object of the type that defines this property, the syntax `o[index]` is used to access the property.
...
```
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/members/indexed-properties

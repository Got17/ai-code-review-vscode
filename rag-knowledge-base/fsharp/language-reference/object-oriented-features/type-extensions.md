...
*   The `self-identifier` token in the [syntax](type-extensions#syntax) represents the instance of the type being invoked, just like ordinary members.
...
*   Type extensions do not support [Statically Resolved Type Parameters](generics/statically-resolved-type-parameters).
*   Optional Type extensions do not support constructors as augmentations.
*   Type extensions cannot be defined on [type abbreviations](type-abbreviations).
...
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/type-extensions

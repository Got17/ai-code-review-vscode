# Interfaces (F#)
_Interfaces_ specify sets of related members that other classes implement.
...
iaString.Get() // "hello"
```
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/interfaces

...
If the function code is not dependent on the type of a parameter, the compiler considers the parameter to be generic. This is called _automatic generalization_, and it can be a powerful aid to writing generic code without increasing complexity.
...
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/type-inference

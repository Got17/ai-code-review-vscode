...
A _statically resolved type parameter_ is a type parameter that is replaced with an actual type at compile time instead of at run time.
...
```
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/generics/statically-resolved-type-parameters

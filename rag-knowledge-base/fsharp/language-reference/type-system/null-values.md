...
This passes the `--checknulls+` [flag](../compiler-options) to the F# compiler and sets a `NULLABLE` [preprocessor directive](../compiler-directives#nullable-directive) for the build.

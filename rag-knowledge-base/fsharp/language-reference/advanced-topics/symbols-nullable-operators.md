...
> **Note**:
>
> Nullable operators are generally only used in [query expressions](../query-expressions). If you don't use query expressions, you don't need to know or use these operators.
...
```
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/symbol-and-operator-reference/nullable-operators

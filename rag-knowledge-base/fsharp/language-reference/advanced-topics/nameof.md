...
The [`nameof` pattern](pattern-matching#nameof-pattern) lets you use `nameof` in a pattern match expression like so:
...
```
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/nameof

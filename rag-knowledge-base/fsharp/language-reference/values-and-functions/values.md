...
## Binding a Value
The term _binding_ means associating a name with a definition. The `let` keyword binds a value, as in the following examples:
...
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/values

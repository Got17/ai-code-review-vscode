...
## Remarks
In the previous syntax, _let-function-binding_ is the definition of a function in a `let` binding.
...
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/entry-point

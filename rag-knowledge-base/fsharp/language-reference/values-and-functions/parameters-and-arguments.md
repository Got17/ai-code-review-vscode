...
## Parameters and Arguments
The term _parameter_ is used to describe the names for values that are expected to be supplied. The term _argument_ is used for the values provided for each parameter.
...
true
```
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/parameters-and-arguments

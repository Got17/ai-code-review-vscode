...
## Remarks
In the previous syntax, _expression1_ runs when the Boolean expression evaluates to `true`; otherwise, _expression2_ runs.
...
```
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/conditional-expressions-if-then-else

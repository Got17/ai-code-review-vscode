# Inline Functions
_Inline functions_ are functions that are integrated directly into the calling code.
...
> Reference: https://learn.microsoft.com/en-us/dotnet/fsharp/language-reference/functions/inline-functions

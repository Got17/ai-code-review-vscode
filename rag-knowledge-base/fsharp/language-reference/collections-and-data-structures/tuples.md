# Tuples
A _tuple_ is a grouping of unnamed but ordered values, possibly of different types. Tuples can either be reference types or structs.
...
## Remarks
Each _element_ in the previous syntax can be any valid F# expression.
